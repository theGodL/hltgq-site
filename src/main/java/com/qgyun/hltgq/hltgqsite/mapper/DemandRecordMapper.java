...
/**
 * 需水预测方案主表 Mapper（t_auto_hltgq_water_demand_record）
 */
@Mapper
public interface DemandRecordMapper extends BaseMapper<DemandRecord> {

    /** 启动清理：遗留 calculating 超时置 failed，返回影响行数 */
    @Update("UPDATE \"qixiao-apaas\".\"t_auto_hltgq_water_demand_record\" " +
