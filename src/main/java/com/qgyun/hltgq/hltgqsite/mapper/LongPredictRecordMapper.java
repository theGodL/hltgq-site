...
/**
 * 中长期来水预测方案主表 Mapper（t_auto_hltgq_water_long_predict_record）
 */
@Mapper
public interface LongPredictRecordMapper extends BaseMapper<LongPredictRecord> {

    /** 启动清理：遗留 calculating 超时置 failed，返回影响行数 */
    @Update("UPDATE \"qixiao-apaas\".\"t_auto_hltgq_water_long_predict_record\" " +
